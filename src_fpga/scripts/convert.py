...
def parse_cmdline():
  ...
  p.add_argument(       "--vfile",       type=str,   default=os.path.join(find_top_level(), "src_fpga", "build", "out.v")  )
  p.add_argument(       "--lookup",      type=str,   default=os.path.join(find_top_level(), "src_fpga", "build", "sine_wave_lookup_160832.v") )
  p.add_argument(       "--out",         type=str,   default=os.path.join(find_top_level(), "src_fpga", "fpga_converted.v") )
