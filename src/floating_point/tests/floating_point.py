...
from src.floating_point.harnesses.floating_point import FloatingPoint


# Creates a test harness class for the `FloatingPoint` module.
...
def create_model(n):
    model = FloatingPoint(n)

    # Create a harness wrapping our `FloatingPoint` module.
