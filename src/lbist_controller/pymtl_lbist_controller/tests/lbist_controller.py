...
from src.lbist_controller.harnesses.lbist_controller import LbistController


# Creates a test harness class for the `LbistController` module.
...
def create_model(n):
    model = LbistController(n)

    # Create a harness wrapping our `LbistController` module.
