...
from src.distance_cal.harnesses.distance_cal import DistanceCal


# Creates a test harness class for the `DistanceCal` module.
...
def create_model(n):
    ...
    # Create a harness wrapping our `DistanceCal` module.
