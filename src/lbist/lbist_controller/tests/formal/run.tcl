...
analyze -sv lbist/lbist_controller/lbist_controller.v lbist/lbist_controller/tests/formal/lbist_controller_sva.sv

# specify the top level module, in this case the testbench 
elaborate -top lbist_controller -create_related_covers {precondition witness}
