...
def test_random (n, d):
  run_test_vector_sim( FpCombMultVRTL(n,d,1), gen_random_test_case(n,d,100), cmdline_opts )

def test_random_i32_16( cmdline_opts ):
  run_test_vector_sim( FpCombMultVRTL(32,16,1), gen_random_test_case(32,16,100), cmdline_opts )
