...
from src.classifier.harnesses.classifier import Classifier


# Creates a test harness class for the `Classifier` module.
...
def create_model(n):
    ...
    # Create a harness wrapping our `Classifier` module.
