...
from src.transfer_spi.harnesses.transfer_spi import TransferSpi


# Creates a test harness class for the `TransferSpi` module.
...
def create_model(n):
    ...
    # Create a harness wrapping our `TransferSpi` module.
