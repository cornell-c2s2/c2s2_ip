...
from src.tapeins.sp24.tapein2.interconnect import InterconnectWrapper
...
def make_interconnect(cmdline_opts):
    dut = InterconnectWrapper()
    dut = config_model_with_cmdline_opts(dut, cmdline_opts, duts=["dut"])
