...
from src.demodulator.harnesses.demodulator import Demodulator


# Creates a test harness class for the `Demodulator` module.
...
def create_model(n):
    ...
    # Create a harness wrapping our `Demodulator` module.
