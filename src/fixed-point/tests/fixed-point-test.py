...
from fixed-point import FixedPointVRTL

# Creates a test harness class for the `FixedPoint` module.
...
def create_model(n):
	model = FixedPointVRTL(n)

    # Create a harness wrapping our `FixedPoint` module.
