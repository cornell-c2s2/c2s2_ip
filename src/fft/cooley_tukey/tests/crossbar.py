...
from src.fft.cooley_tukey.harnesses.crossbar import Crossbar
...
def simple_msgs_6_64_4(bits, fft_size):
    ...
    msgs = [
        msg(arr[::-1], bits, fft_size),
        msg(arr_ans[::-1], bits, fft_size),
        msg(arr, bits, fft_size),
        msg(arr_ans, bits, fft_size),
    ]
    return msgs
...
def test(test_params, cmdline_opts):
    th = TestHarness(
        Crossbar(test_params.BIT_WIDTH, test_params.SIZE_FFT, test_params.STAGE_FFT),
        test_params.BIT_WIDTH,
        test_params.SIZE_FFT,
