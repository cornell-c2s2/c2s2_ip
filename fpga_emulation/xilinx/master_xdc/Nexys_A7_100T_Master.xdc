...
#7 segment display
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { cathode[0] }]; #IO_L24N_T3_A00_D16_14 Sch=ca  ; upper center segment
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { cathode[1] }]; #IO_25_14 Sch=cb               ; right segment
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { cathode[2] }]; #IO_25_15 Sch=cc               ; right segment
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { cathode[3] }]; #IO_L17P_T2_A26_15 Sch=cd      ; lower center segment
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { cathode[4] }]; #IO_L13P_T2_MRCC_14 Sch=ce     ; lower left segment
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { cathode[5] }]; #IO_L19P_T3_A10_D26_14 Sch=cf  ; upper left segment
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { cathode[6] }]; #IO_L4P_T0_D04_14 Sch=cg       ; middle center segment
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { cathode[7] }]; #IO_L19N_T3_A21_VREF_15 Sch=dp ; decimal point
