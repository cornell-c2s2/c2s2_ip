...
//       wire fft_msg_unused = &{1'b0, fft_send_msg[i], 1'b0};
  ...
  logic signed [DATA_BITS-1:0] signed_classifier_recv_msg [16];
  always_comb begin
    int special;
    for (special=0; special<16; ++special) begin
      signed_classifier_recv_msg[special] = $signed(classifier_recv_msg[special]);
    end
  end
  ...
  classifier_Classifier #(
    ...
    .recv_msg(signed_classifier_recv_msg),
